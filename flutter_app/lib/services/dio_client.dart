...
class DioClient {
  ...
  Future<Response> login(String username, String password) =>
      dio.post(ApiConfig.loginPath, data: {'username': username, 'password': password});
  ...
  Future<Response> patchBranchStatus(int id, {String? status}) =>
      dio.patch(
  ...
  Future<Response> sessions({int? branchId, String? status}) => dio.get(
  ...
  Future<Response> attendedHistory({String? date, String? month, String? dateFrom, String? dateTo, int? branchId, int? examTypeId, String? q}) => dio.get(
  ...
  Future<Response> candidates({String? q, int? branchId, int? teamId}) => dio.get(
  ...
  Future<Response> updateTeam(int id, Map<String, dynamic> data) => dio.put('${ApiConfig.teamsPath}$id/', data: data);
  Future<Response> deleteTeam(int id) => dio.delete('${ApiConfig.teamsPath}$id/');
  Future<Response> teamReport(int id) => dio.get('${ApiConfig.teamsPath}$id/report/');
    ...
    String? dateTo,
      ...
      dio.get(
        ...
        queryParameters: {
          ...
          if (paymentMode != null && paymentMode.isNotEmpty && paymentMode != 'All' && paymentMode != 'All Payment Modes')
  ...
  Future<Response> toggleExpenseCategory(int id, {String? status}) =>
  ...
  Future<Response> vouchers({int? branchId, String? status, String? q}) => dio.get(
        ApiConfig.vouchersPath, queryParameters: {
          if (branchId != null) 'branch_id': branchId,
          if (status != null && status.isNotEmpty) 'status': status,
          if (q != null && q.trim().isNotEmpty) 'q': q.trim(),
        });
  ...
  Future<Response> voucherDashboard({int? branchId}) => dio.get(
        ApiConfig.voucherDashboardPath, queryParameters: {if (branchId != null) 'branch_id': branchId});
  ...
  Future<Response> useVoucher(int id) => dio.post('${ApiConfig.vouchersPath}$id/use/');


  Future<Response> createCandidate(Map<String, dynamic> data) =>
      dio.post(ApiConfig.candidatesPath, data: data);
  ...
  Future<Response> createExamType(Map<String, dynamic> data) =>
      dio.post(ApiConfig.examTypesPath, data: data);

  Future<Response> createBranchMapping(Map<String, dynamic> data) =>
      dio.post(ApiConfig.branchMappingsPath, data: data);

  Future<void> saveTokens(Map<String, dynamic> tokens) async {
    final p = await SharedPreferences.getInstance();
    await p.setString('access_token', '${tokens['access']}');
    if (tokens['refresh'] != null) {
      await p.setString('refresh_token', '${tokens['refresh']}');
    }
  }
