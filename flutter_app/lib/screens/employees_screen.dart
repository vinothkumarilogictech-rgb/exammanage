...
class EmployeesScreenState extends State<EmployeesScreen> {
  ...
  void initState() {
    super.initState();
    branchContext = context.read<BranchContext>();
    branchContext.addListener(_branchChanged);
    load();
  }

  @override
  void dispose() {
    branchContext.removeListener(_branchChanged);
    super.dispose();
  }
  ...
  Future<void> editEmployee([Employee? e]) async {
    ...
    if (bid == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Select a branch from Dashboard first.')),
      );
      return;
    }
    final name = TextEditingController(text: e?.fullName ?? ''),
        des = TextEditingController(text: e?.designation ?? ''),
    ...
    DateTime joining = e == null
        ? DateTime.now()
        : (DateTime.tryParse(e.joiningDate) ?? DateTime.now());
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF6C1FB0).withOpacity(0.3),
                        blurRadius: 14,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              e == null
                                  ? 'Add a new team member to this branch'
                ...
                _formSectionCard(
                  ...
                  children: [
                    field(
                      username,
                      e == null ? 'Username *' : 'Username (optional)',
                    ...
                    Padding(
                      ...
                      child: field(
                        password,
                        e == null ? 'Password *' : 'Password (optional)',
                  ...
                  child: FilledButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      final data = {
                        ...
                        'joining_date':
                            '${joining.year}-${joining.month.toString().padLeft(2, '0')}-${joining.day.toString().padLeft(2, '0')}',
                        'status': status,
                        'branch_id': bid,
                      };
                      if (e == null) {
    ...
    for (final c in [name, des, phone, email, address, username, password]) {
      c.dispose();
    }
  }
  ...
  Future<void> salaryHistory(Employee e) async {
    try {
      final r = await api.employeeSalaryHistory(
        e.id,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('${e.employeeId} • ${e.designation}'),
                const Divider(),
                const Text(
                  'Salary History',
                ...
                if (rows.isEmpty)
                  const Padding(
                    ...
                    child: Center(child: Text('No salary payments yet.')),
                  )
                else
                  ...rows.map(
                    (x) => ListTile(
                      ...
                      title: Text('₹ ${x['amount']}'),
                      subtitle: Text(
                        '${x['date_incurred'] ?? ''} • ${x['payment_mode'] ?? ''}',
                      ),
                    ),
                  ),
              ],
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: loading
        ? const Center(
            child: CircularProgressIndicator(color: Color(0xFF9A22C7)),
          )
        : RefreshIndicator(
            ...
            child: employees.isEmpty
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const Text(
                              'Build your team by adding the first employee to this branch.',
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (_, i) {
                      final e = employees[i];
                      final initial = e.fullName.isEmpty
                          ? '?'
